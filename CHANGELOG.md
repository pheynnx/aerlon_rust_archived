...
- css code block styling has been updated

## [0.13.5] - 2023-08-22

#### Changed

- more work on /blog and navbar

## [0.13.4] - 2023-08-22

#### Changed

- cleaning up a lot of the asset building
- blog post page will be being reworked; begin work here
- navbar is being rebuilt

## [0.13.3] - 2023-08-20

#### Changed

- rethinking how the navbar looks
  - super WIP

#### Removed

- the WIP top bar with versioning

## [0.13.2] - 2023-08-20

#### Fixed

- esbuild will compile to the new updated web directory

## [0.13.1] - 2023-08-18

#### Changed

- markdown code blocks are now being parsed with css classes and not in-line color styles
- removing more reliance on node and package.json
  - currently still using it for minifying .js files and building /admin solidjs build

## [0.13.0] - 2023-08-18

#### Changed

- starting work on migrating away from outside dependancy and node/package.json
  - admin will need to be rewritten with vanillajs and probably htmx
